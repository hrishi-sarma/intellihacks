...
multi_ai_agent=Agent(
   ...
   model=Groq(id="llama-3.3-70b-versatile"),
   instructions=["Use the web search agent to find information about the company and the financial agent to find information about the stock.","Use table to display the data"],
   show_tools_calls=True,
   markdown=True, 
)
